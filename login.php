...
<html lang="en">
  <head>
    ...
    <a href="index.php"><button type="button" class="btn btn-danger" style="margin-top:15px; margin-left:15px; text-transform:none ">Voltar</button></a>
	<section class="ftco-section">
		<div class="container">
			...
			<div class="row justify-content-center">
	            ...
	            <div class="form-group">
	            	<button type="submit" class="form-control btn btn-primary submit px-3 inputSubmit"   type="submit" name="submit" value="Enviar" style="text-transform:none" >Entrar</button>
	            </div>
