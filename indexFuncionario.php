...
<body>
  <nav>
   ...
   <label class="logo"> <a href="indexFuncionario.php" class="aLogo">Neguinho Corts</a></label>
    <!-- Navigation links -->
    <ul>
      <li><a class="active" href="#">Página Principal</a></li>
      <li><a class="" href="cadastrofuncionario.php">Cadastrar Funcionários</a></li>
      <li><a class="" href="verAgendamentos.php">Ver Agendamentos</a></li>
...
<style>
  ...
  <header>
        <div class="overlay">
            ...
            <div class="buttons">
                <a href="https://booksy.com/pt-br/instant-experiences/widget/247164,309667" target="_blank"></a>
        ...
        <div class="card border-0">
          ...
          <div class="card-footer border border-top-0 bg-white p-4">
            ...
            <div class="d-flex justify-content-between mt-3">
              <a href="#agendar" class="btn btn-dark">Agendar </a>
      ...
      <div class="col-12 col-lg-4">
        <div class="card border-0">
          ...
          <div class="card-footer border border-top-0 bg-white p-4">
            ...
            <div class="d-flex justify-content-between mt-3">
              <a href="#agendar" class="btn btn-dark">Agenda</a>
